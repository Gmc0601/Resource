...
- (void)setImageAndTitle{
    ...
    [self.ProtraitImg sd_setImageWithURL:[NSURL URLWithString:[ConfigModel getStringforKey:HeadImage]] placeholderImage:[UIImage imageNamed:@"mrtx144"] completed:nil];
    ...
    if ([[ConfigModel getStringforKey:@"PersonNickName"] isEqualToString:@"(null)"]) {
        ...
        [self.nickNameBtn setTitle:[ConfigModel getStringforKey:NickName] forState:UIControlStateNormal];
    }
