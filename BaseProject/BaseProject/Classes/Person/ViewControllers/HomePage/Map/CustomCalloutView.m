...
//    self.phoneBtn.frame = CGRectMake(270, 10, 20, 20);
...
//    [self.phoneBtn setImage:[UIImage imageNamed:@"icon_nav_dh"] forState:UIControlStateNormal];
//    [self.phoneBtn addTarget:self action:@selector(playPhone:) forControlEvents:UIControlEventTouchUpInside];
